                        ...
                        <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                            <div className="d-flex bg-light p-3 rounded">
                                ...
                                <div className="ms-3">
                                    ...
                                    <a href="https://goo.gl/maps/Zd4BCynmTb98ivUJ6" style={{fontSize:'15px'}} target="_blank" className="h5">23 rank Str, Noida</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                            <div className="d-flex bg-light p-3 rounded">
                                ...
                                <div className="ms-3">
                                    ...
                                    <a className="h5" href="tel:+917470360840" style={{fontSize:'15px'}} target="_blank">+91 7470360840</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                            <div className="d-flex bg-light p-3 rounded">
                                ...
                                <div className="ms-3">
                                    ...
                                    <a className="h5" href="mailto:neutronsoftwarepvt@gmail.com" style={{fontSize:'15px'}} target="_blank">neutronsoftware@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
